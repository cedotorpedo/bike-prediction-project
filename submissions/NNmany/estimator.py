...
def _merge_external_data(X):
    ...
    X = pd.merge_asof(
        X.sort_values("date"), df_ext[["date", "ww","conf","hourly","t","nbas","etat_sol","vacances_zone_c",'rr1','Intensev1','Vehicules','raf10']].sort_values("date"), on="date"
    )
...
def get_estimator():
    ...
    numerical_cols = ['rr1','Intensev1','Vehicules','raf10']
